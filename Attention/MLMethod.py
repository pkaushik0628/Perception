...
def extract_region_signals(nwb_file_path, electrode_type='macro', regions=None, top_n=8, fs_lfp=1000, fs_eye=500):
    ...
    electrodes_df = electrodes_df[electrodes_df['group_name'].str.contains('macro', case=False, na=False)]
...
def prepare_dataset(participant_ids, regions, fs_lfp=1000, fs_eye=500):
    ...
    for pid in participant_ids:
        ...
        # LFP signals
        region_signals = extract_region_signals(nwb_file_path=nwb_path, electrode_type='macro', regions=regions, fs_lfp=fs_lfp, fs_eye=fs_eye)
